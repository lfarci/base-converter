    ...
    <main className="mx-auto w-full px-4 pb-16 text-ink sm:px-6 lg:max-w-[920px]" id="top">
      ...
      <section aria-labelledby="page-title">
        ...
        <div className="mt-4 rounded-[3px] border border-frame border-t-[3px] border-t-frame bg-panel shadow-[2px_2px_0_var(--color-rule)]">
          ...
          <div className="flex flex-wrap items-center gap-x-2 gap-y-2 border-b border-rule-soft bg-paper-2 px-3 pt-7 pb-0">
            <div className="flex min-w-0 items-center gap-1">
              ...
              <span className="relative -top-3 inline-flex items-center gap-0.5">
                <output className="inline-flex h-10 min-w-9 items-center justify-center border-2 border-frame bg-well px-1.5 mono-tech text-[12px] font-bold text-ink shadow-[inset_1px_1px_0_rgb(23_43_77_/_0.22),inset_-1px_-1px_0_rgb(255_255_255_/_0.72)]" id="selected-bit-width" aria-label="Selected bit width">
                  {positions}
                </output>
