...
export function statusFor(parsed: ParsedDigits, base: Base, rejection: string) {
...
export function displayedRows(sourceKey: string, sourceDigits: string, value: bigint | null): DisplayedRow[] {
