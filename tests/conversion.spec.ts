...
test('width slider snaps with keyboard and pointer, and breakdowns toggle in bulk', async ({ page }) => {
  ...
  if (!guidanceBounds || !buttonBounds || !widthControlBounds || !widthLabelBounds) return
  ...
  if (!mobileButtonBounds || !mobileGuidanceBounds || !mobileSliderBounds || !mobileLabelBounds) return
